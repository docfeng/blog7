	...
	function jryd() {
		...
		<html>
			...
			<body>
				...
				<script>
					var nexturl=dqurl,
					nextt="",xsnr,tcdzt,tztdx,tzthg,fysz,khwb;
					...
					document.addEventListener("scroll",dddb);
					function dddb(){
				...
				<div id="szcsp">
				<div id="szcsp2" >
					<p><span id="csztjx">\u3000A-\u3000</span>\u3000<span id="csztzd">\u3000A+\u3000</span></p>
					<p id="cszt"></p>
		...
		cpfy.innerHTML =
			...
			document.addEventListener("touchmove",function(e){
				endY=e.changedTouches[0].clientY,endY-startY>0?($("#txtcd").style.display="block",tcdzt=1):yctcd()
			});
			function yctcd(){
				"1"==tcdzt&&($("#txtcd").style.display="none",$("#szcsp").style.display="none",tcdzt=0)
			};
			$("#txtcd").addEventListener("click",function(){
				$("#szcsp").style.display="block";tcdzt=1
			}),
